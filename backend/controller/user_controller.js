...
// // ✅ GET PROFILE - Current user ka data
// exports.getProfile = async (req, res) => {
//     try {
//         const userId = req.user.id;
//         const user = await User.findById(userId).select('-password'); // Password mat bhejo
...
// // ✅ UPDATE PROFILE - Name, Phone, Address update
// exports.updateProfile = async (req, res) => {
//     try {
//         const userId = req.user.id;
//         const { name, phone, address, city, pincode, imageUrl } = req.body;
//         const file = req.files.imageFile; // Assuming the file input name is 'imageFile'
...
//         // ✅ SIRF WO FIELDS UPDATE KARO JO AAYE HAIN
//         let updated = false;
