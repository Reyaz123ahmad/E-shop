...
exports.verifySignature = async (req, res) => {
    try {
        ...
        setImmediate(() => {
            ...
            emailService.orderConfirmationEmailService(user, newOrder)
                .then(() => console.log("✅ Email sent"))
                .catch((emailError) => console.log("⚠️ Email error:", emailError.message))
            
            emailService.sellerOrderConfirmationEmailService(user, sellerDetails, newOrder)
                .then(() => console.log("✅ Seller email sent"))
                .catch((emailError) => console.log("⚠️ Seller email error:", emailError.message))
        })
